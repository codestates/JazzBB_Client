import {  SET_TOKEN, SAVE_REDUCER, SET_USER, IS_LOGIN, FINISH_ACTION,SET_JAZZID_BOSS} from "./action";
import ouathState from "./ouathState";

const oauthReducer = (state = ouathState, action) => {
  ...
  switch (action.type) {
    ...
    case IS_LOGIN:
      return Object.assign({}, state, { isLogin: payload.data });
