...
import AddShowInput from "./AddShowInput"
        ...
        <div className="content">
          ...
          <div className="top-section">
            ...
            <div className="inputBox">
              <input type="text" placeholder="공연제목" className="input"></input>
              <input type="date" className="input"></input>
              <input type="text" placeholder="공연시간" className="input"></input>
              <BiPlusCircle onClick={addInputTime}/>
